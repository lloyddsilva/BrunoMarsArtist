...
public class MainActivity extends ActionBarActivity
        ...
        SongsFragment.OnFragmentInteractionListener, VideosFragment.OnFragmentInteractionListener,
        WallpaperFragment.OnFragmentInteractionListener, MailingListFragment.OnFragmentInteractionListener {
    ...
    public void onNavigationDrawerItemSelected(int position) {
        ...
        switch(position) {
            ...
            case 3: fragmentManager.beginTransaction()
                    .replace(R.id.container, WallpaperFragment.newInstance())
                    .commit();

                    break;

            case 4: fragmentManager.beginTransaction()
                    .replace(R.id.container, MailingListFragment.newInstance())
                    .commit();
